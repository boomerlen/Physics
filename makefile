...
# Overall output
$(BIN)/Physics: $(OBJ)/src/Matrix.o $(OBJ)/src/PhysVector.o $(OBJ)/src/Scalar.o $(OBJ)/src/Node_T.o $(OBJ)/src/Ordered_Set.o $(OBJ)/src/Numerical.o $(OBJ)/src/PhysExcept.o $(OBJ)/main.o
	$(CC) -o $(BIN)/Physics $(OBJ)/src/Matrix.o $(OBJ)/src/PhysVector.o $(OBJ)/src/Scalar.o $(OBJ)/src/Node_T.o $(OBJ)/src/Ordered_Set.o $(OBJ)/src/Numerical.o $(OBJ)/src/PhysExcept.o $(OBJ)/main.o $(FLAGS)
